...
// chart 1
  ...
  var ctx = document.getElementById("dashboard5-chart-1").getContext('2d');
...
// chart 2
 ...
 var ctx = document.getElementById("dashboard5-chart-2").getContext('2d');
...
// chart 3
 ...
 var ctx = document.getElementById('dashboard5-chart-3').getContext('2d');
...
var ctx = document.getElementById("dashboard5-chart-4").getContext('2d');
  ...
  // chart 5
    ...
    var ctx = document.getElementById("dashboard5-chart-5").getContext('2d');
