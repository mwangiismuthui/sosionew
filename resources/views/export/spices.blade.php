            ...
            <div class="col-sm-12">
                ...
                <div itemscope="" itemtype="" class="product type-product row columns_padding_25">
                    ...
                    <div class="summary entry-summary col-sm-6">
                        ...
                        <h2 itemprop="name" class="product_title ">Pepper</h2>


                        <div>
                            <p>Pepper is known worldwide for the hearty taste it gives meals. Demand for pepper from Kenya continues to grow strong, thanks to the numerous benefits pepper brings to the dining tables of millions of consumers around the world.If you are an importer of Kenya pepper,we do all the donkey work of sourcing the top-of-the-range crop while adhering to strict best practices, purchasing pepper of matching quality from other Kenyan farmers,  and assorting it for export.Yours is only to place your orders and wait for us to deliver Kenya pepper of impeccable quality to whichever country of the world you are located.</p>
                            <h5 style="text-align:center;">Our varieties</h5>
                            <ol>
                                <li> Capsicum sweet pepper</li>
                                <p>Available in both red and yellow colors</p>
                                <li>African Bird’s Eye Chilies</li>
                                <p>They are red in color</p>
                                <li>Hot pepper</li>
                                <li>Green pepper</li>
                                <li>Black pepper</li>
                            </ol>
                    ...
                    <div itemscope="" itemtype="" class="product type-product row columns_padding_25">
                        ...
                        <div class="summary entry-summary col-sm-6">
                            ...
                            <div>
                                ...
                                <p>Our turmeric meets the high threshold of quality that meets and exceeds the highest standards expected in world markets.We welcome you to order fresh Kenya turmeric from us. Wherever you need it around the world, we’ll get it to you.</p>
                            </div>
