...
// chart 1
  ...
  var ctx = document.getElementById("dashboard6-chart-1").getContext('2d');
...
// chart 2
 ...
 var ctx = document.getElementById("dashboard6-chart-2").getContext('2d');
...
// chart 3
 ...
 var ctx = document.getElementById('dashboard6-chart-3').getContext('2d');

  var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStroke1.addColorStop(0, '#BC0000');
...
var ctx = document.getElementById("dashboard6-chart-4").getContext('2d');
  ...
  // chart 5
    ...
    var ctx = document.getElementById("dashboard6-chart-5").getContext('2d');
