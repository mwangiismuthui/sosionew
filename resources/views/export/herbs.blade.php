        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div itemscope="" itemtype="" class="product type-product row columns_padding_25">
                    ...
                    <div class="col-sm-6">
                        <div class="item-media images muted_background text-center rounded overflow_hidden" id="">
                            ...
                            <a href="/images/events/new/mint3.jpg" itemprop="image" class="woocommerce-main-image zoom prettyPhoto" data-gal="prettyPhoto[product-gallery]">
                                <img src="/images/events/new/mint3.jpg" class="attachment-shop_single wp-post-image" alt="mint-in-kenya" title="" >
                            </a>

                            <div class="cs main_color3 entry-meta media-meta vertical-center text-center">
                                <div class="price weight-black fontsize_30">
                                    <span>
                                        <span class="amount">Mint</span>
                                    </span>
                                </div>
                                <div>
                    ...
                    <div class="summary entry-summary col-sm-6">
                        ...
                        <h1 itemprop="name" class="product_title ">Mint</h1>


                        <div style="text-align:justify;">
                            <p>Mint has been used for various purposes since ancient times: as a medicinal herb, for culinary purposes in the kitchen as an aromatic addition to foods and drinks, and as a deodorizer, among other uses. In traditional Indian medicine for example, mint is an effective treating  stomach upsets. In Europe, it has been used as a deodorizer for long. Mint is also commonly used in aromatherapy in its essential oil form today for its ability to relieve seasonal allergy.its also packed with magnesium,calcium,vitamin C, iron and vitamin A</p>
                            <p>Our Kenyan mint, just like the other herbs we source from farmers, is produced naturally in the rich, dark and nurturing fertile soil of Kenya using a combination of traditional farming methods and modern techniques. We rigidly control our suppliers and sources to ensure that only the freshest, most flavorful mint of the highest quality reaches the plates of people in Kenya and around the world. Kenya mint is ideal for use both as garnishing for dishes and drinks, and as a cooked preparation.</p>
                            <p>Come, breathe in a whiff of our fresh Kenya mint-you will never find cooler, fresher mint</p>
                        </div>
                ...
                <!-- .product.row -->
                    ...
                    <div itemscope="" itemtype="" class="product type-product row columns_padding_25">
                        ...
                        <div class="summary entry-summary col-sm-6">
                            ...
                            <div style="text-align:justify;">
                                ...
                                <p>We are a proud supplier of fresh and high quality Kenyan thyme,a ensuring that its freshness will reach millions of shopping bags miles away, worldwide. Kenya thyme is planted in heavy ground at high altitudes all year round and full sun, which makes Kenya a permanent source of the herb.</p><p>We take great care of our herbs and spices and as we source them from farmers, we know that we are literally sharing the same plate with our customers. You are assured of the best quality of Kenya thyme from us.</p>
                            </div>
                            <a href="{{route('order')}}" class="theme_button color3">
                                Order Thyme Now
                              </a>
                    ...
                    <div itemscope="" itemtype="" class="product type-product row columns_padding_25">
                        ...
                        <div class="summary entry-summary col-sm-6">
                            ...
                            <div style="text-align:justify;">
                                ...
                                <p>Chives can also be grown on your window sill, but nothing can replace those chives that come from Kenya. Feel free to experiment with Kenya chives and bring aromatic meals from Africa.</p>
                                <p>With us by your side, we are glad to deliver it to your destination on time</p>
                            </div>
                            <a href="{{route('order')}}" class="theme_button color3">
                                Order Chives Now
                              </a>
                    ...
                    <div itemscope="" itemtype="http://schema.org/Sage" class="product type-product row columns_padding_25">
                        ...
                        <div class="summary entry-summary col-sm-6">
                            ...
                            <div style="text-align:justify;">
                                ...
                                <p>Apart from its culinary uses, it is also used to reduce blood sugar lever, lower cholestral, protects against certain cancers, and may ease menopause symptoms such as hot flashes and irritability. Sage is loaded with antioxidants, magnesium, zinc, copper and vitamins A, C and E.It is also a natural cleaning agent.</p>
                                <p> Our Kenyan sage, just like the other herbs we source from farmers, is produced naturally in the rich, well drained sandy soil. We rigidly control our suppliers and sources to ensure that only the freshest, most flavorful sage of the highest quality reaches the plates of people in Kenya and around the world.</p>
                            </div>
                            <a href="{{route('order')}}" class="theme_button color3">
                                Order Sage Now
                              </a>
                    ...
                    <div itemscope="" itemtype="http://schema.org/Tarragon" class="product type-product row columns_padding_25">
                        ...
                        <div class="col-sm-6">
                            <div class="item-media images muted_background text-center rounded overflow_hidden" id="">
                                ...
                                <div class="cs main_color3 entry-meta media-meta vertical-center text-center">
                                    <div class="price weight-black fontsize_30">
                                        <span>
                                            <span class="amount">Tarragon</span>
                                        </span>
                                    </div>
                                    <div>
                    ...
                    <!-- .product.row -->
                       ...
                       <div itemscope="" itemtype="http://schema.org/Corriander" class="product type-product row columns_padding_25">
                        ...
                        <div class="col-sm-6">
                            <div class="item-media images muted_background text-center rounded overflow_hidden" id="">
                                ...
                                <div class="cs main_color3 entry-meta media-meta vertical-center text-center">
                                    <div class="price weight-black fontsize_30">
                                        <span>
                                            <span class="amount">Corriander</span>
                                        </span>
                                    </div>
                                    <div>
                        ...
                        <div class="summary entry-summary col-sm-6">
                            ...
                            <p>We observe strict quality standards for the growing, harvesting, and supply of coriander from Kenya. We source fresh coriander from local farmers. This is to ensure the product gets to you as fresh as possible. Whatever variety of Kenya coriander you need.</p>
                            </div>
                            <a href="{{route('order')}}" class="theme_button color3">
                    ...
                    <!-- .product.row -->
                      ...
                      <div itemscope="" itemtype="http://schema.org/Basil" class="product type-product row columns_padding_25">
                        ...
                        <div class="summary entry-summary col-sm-6">
                            ...
                            <div style="text-align:justify;">
                                ...
                                <p>Our partner farmers adhere to the best practices for growing the crop while our team is present in the harvesting, packaging, and exporting of basil, to ensure that you get the highest standards in health and safety in each leaf of basil.</p>
                            ...
                            <div class="vertical-item product text-center">
                                <div class="item-media muted_background rounded overflow_hidden" id="">
                                    ...
                                    <div class="cs main_color4 entry-meta media-meta vertical-center text-center">
                                        <div class="price weight-black fontsize_30">
                                            <span>
                                                <span class="amount">Tumeric</span>
                                            </span>
                                        </div>
                                        <div>
